...
CREATE TABLE `smbms_dept`  (
  ...
  `deptName` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '部门名称',
...
-- ----------------------------
INSERT INTO `smbms_dept` VALUES (1, '一部');
INSERT INTO `smbms_dept` VALUES (2, '二部');
INSERT INTO `smbms_dept` VALUES (3, '三部');
...
INSERT INTO `smbms_role` VALUES (4, '\r\nprogrammer', '程序员', 1, '2022-04-12 10:02:04', NULL, NULL);
...
CREATE TABLE `smbms_user`  (
  ...
  `gender` int(10) NOT NULL COMMENT '性别（1:女、 2:男）',
  `birthday` date NULL DEFAULT NULL COMMENT '出生日期',
  `dept_id` int(10) NULL DEFAULT NULL COMMENT '部门(取自部门表-部门id)',
  `role_id` int(10) NULL DEFAULT NULL COMMENT '用户角色（取自角色表-角色id）',
  `address` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '地址',
  `userSchool` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '毕业院校',
  `userCode` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '工号',
  ...
  `card_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '身份证号',
  `bank` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '银行卡号',
  ...
  `wages` decimal(10, 2) NULL DEFAULT NULL COMMENT '工资',
  `createdBy` bigint(20) NULL DEFAULT NULL COMMENT '创建者（userId）',
  `creationDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modifyBy` bigint(20) NULL DEFAULT NULL COMMENT '更新者（userId）',
  `modifyDate` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
-- ----------------------------
INSERT INTO `smbms_user` VALUES (1, '系统管理员', 1, '1997-01-01', 1, 1, '湖南省衡阳市蒸湘区南华大学', '西安大学', 'wen', '123', '15200981234', '620511199908083351', '6212262201023557228', '4686466@qq.com', '2022-04-15', 10000.00, 1, '2019-04-07 10:15:55', 1, '2022-04-13 16:18:09');
INSERT INTO `smbms_user` VALUES (5, '韩路彪', 2, '1984-06-05', NULL, 2, '北京市朝阳区北辰中心12号', NULL, 'hanlubiao', '0000000', '18567542321', NULL, NULL, NULL, NULL, NULL, 1, '2014-12-31 19:52:09', NULL, NULL);
INSERT INTO `smbms_user` VALUES (6, '张华', 1, '1983-06-15', NULL, 3, '北京市海淀区学院路61号', NULL, 'zhanghua', '0000000', '13544561111', NULL, NULL, NULL, NULL, NULL, 1, '2013-02-11 10:51:17', NULL, NULL);
INSERT INTO `smbms_user` VALUES (7, '王洋', 2, '1982-12-31', NULL, 3, '北京市海淀区西二旗辉煌国际16层', NULL, 'wangyang', '0000000', '13444561124', NULL, NULL, NULL, NULL, NULL, 1, '2014-06-11 19:09:07', NULL, NULL);
INSERT INTO `smbms_user` VALUES (8, '赵燕', 1, '1986-03-07', NULL, 3, '北京市海淀区回龙观小区10号楼', NULL, 'zhaoyan', '0000000', '18098764545', NULL, NULL, NULL, NULL, NULL, 1, '2016-04-21 13:54:07', NULL, NULL);
INSERT INTO `smbms_user` VALUES (10, '孙磊', 2, '1981-01-04', NULL, 3, '北京市朝阳区管庄新月小区12楼', NULL, 'sunlei', '0000000', '13387676765', NULL, NULL, NULL, NULL, NULL, 1, '2015-05-06 10:52:07', NULL, NULL);
INSERT INTO `smbms_user` VALUES (11, '孙兴', 2, '1978-03-12', NULL, 3, '北京市朝阳区建国门南大街10号', NULL, 'sunxing', '0000000', '13367890900', NULL, NULL, NULL, NULL, NULL, 1, '2016-11-09 16:51:17', NULL, NULL);
INSERT INTO `smbms_user` VALUES (12, '张晨', 1, '1986-03-28', NULL, 3, '朝阳区管庄路口北柏林爱乐三期13号楼', NULL, 'zhangchen', '0000000', '18098765434', NULL, NULL, NULL, NULL, NULL, 1, '2016-08-09 05:52:37', 1, '2016-04-14 14:15:36');
INSERT INTO `smbms_user` VALUES (13, '邓超', 2, '1981-11-04', NULL, 3, '北京市海淀区北航家属院10号楼', NULL, 'dengchao', '0000000', '13689674534', NULL, NULL, NULL, NULL, NULL, 1, '2016-07-11 08:02:47', NULL, NULL);
INSERT INTO `smbms_user` VALUES (14, '杨过', 2, '1980-01-01', NULL, 3, '北京市朝阳区北苑家园茉莉园20号楼', NULL, 'yangguo', '0000000', '13388886623', NULL, NULL, NULL, NULL, NULL, 1, '2015-02-01 03:52:07', NULL, NULL);
INSERT INTO `smbms_user` VALUES (17, '张三', 1, '2022-04-12', NULL, 4, '陕西省西安市', NULL, '15', '1234567', '18293817264', NULL, NULL, NULL, NULL, NULL, 1, '2022-04-12 14:32:44', NULL, NULL);
